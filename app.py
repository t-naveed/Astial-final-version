...
if selected == "Home":
    ...
    with st.container():
        ...
        with right_column:
            ...
            st.write("###")
            string = "While your employees are your greatest asset, they can also be your " \
                          "biggest threat regarding cyber security 🚨Between phishing, social engineering attacks, malware distribution, \
                            password theft and breaches, there has never been a greater need for non-technical employees to maintain a cyber culture.\n "\
            "\nIt's important to not only show that we are capable of launching campaigns but we want to also offer a" \
